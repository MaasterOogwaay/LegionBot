 ...
 */
 ...
 client.on('message', message => {
    ...
    client.user.setActivity('>>help | For help with commands', {type: 'PLAYING'});
    ...
    try {
      ...
      client.on('guildMemberAdd', member => {
          ...
          const welcomeEmbed = new Discord.MessageEmbed()
            ...
            .addField('\u200B','In order to unlock the rest of the server, you must do a few things.\n 1 go to #bot\n 2 Set your region.\n 3 Set your platform.\n 4 Finally, you can unlock the server')
...
client.on('message', message => {
    if (message.author.bot) 
    {
        if (message.embeds)
        { 
            const embedMsg = message.embeds.find(msg => msg.title === 'React to obtain your region role');
            if (embedMsg)
            {
                message.react('738860202350215274')
